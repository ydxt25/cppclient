#############################################################################
# Makefile for building: cppclient
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  cppclient.pro
# Template: app
# Command: /opt/Qt5.2.1/5.2.1/gcc_64/bin/qmake -o Makefile cppclient.pro
#############################################################################
...
INCPATH       = -I/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/linux-g++ -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/opt/Qt5.2.1/5.2.1/gcc_64
LIBS          = $(SUBLIBS) -lboost_system 
AR            = ar cqs
RANLIB        = 
...
Makefile: cppclient.pro /opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/common/shell-unix.conf \
		/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/features/lex.prf \
		cppclient.pro
	$(QMAKE) -o Makefile cppclient.pro
...
dist: 
	@test -d .tmp/cppclient1.0.0 || mkdir -p .tmp/cppclient1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cppclient1.0.0/ && (cd `dirname .tmp/cppclient1.0.0` && $(TAR) cppclient1.0.0.tar cppclient1.0.0 && $(COMPRESS) cppclient1.0.0.tar) && $(MOVE) `dirname .tmp/cppclient1.0.0`/cppclient1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cppclient1.0.0
